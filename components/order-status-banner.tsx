...
export function OrderStatusBanner({ order }: { order: OrderData }) {
  ...
  if (status === "delayed") {
    return (
      <Card className="rounded-2xl border-amber-200/90 dark:border-amber-900/60 bg-amber-50/70 dark:bg-amber-950/20 p-4 shadow-2xs">
  ...
  if (status === "tracking_not_available") {
    return (
      <Card className="rounded-2xl border-neutral-200 dark:border-neutral-800 bg-neutral-50/60 dark:bg-neutral-900/30 p-4 shadow-2xs">
        <CardContent className="p-0 space-y-3">
          <div className="flex items-center gap-2.5">
